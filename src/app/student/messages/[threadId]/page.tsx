  ...
  return (
    <div className="bg-white rounded-2xl border border-slate-100 shadow-sm flex flex-col h-[calc(100vh-12rem)] overflow-hidden">
      ...
      <div className="flex items-center gap-3 p-4 border-b border-slate-100">
        <Link href="/student/messages" className="text-slate-400 hover:text-slate-700 lg:hidden">
        ...
        {thread.other.role === "TEACHER" && (
          <Link
            href={`/tutors/${thread.other.id}`}
            className="ml-auto text-sm font-semibold text-highfive-blue hover:underline"
          >
            View profile
          </Link>
        )}
